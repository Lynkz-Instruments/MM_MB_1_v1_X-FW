...
enum minmea_gga_fix_type {
    MINMEA_GGA_FIX_NOT_AVAILABLE = 0,
    MINMEA_GGA_FIX_GPS_FIX = 1,
    MINMEA_GGA_FIX_DIFF_GPS_FIX = 2,
    MINMEA_GGA_FIX_PPS_FIX = 3,
    MINMEA_GGA_FIX_RTK = 4,
    MINMEA_GGA_FIX_FLOAT_RTK = 5,
    MINMEA_GGA_FIX_ESTIMATED = 6,
    MINMEA_GGA_FIX_MANUAL_IN = 7,
    MINMEA_GGA_FIX_SIMULATION = 8
};
