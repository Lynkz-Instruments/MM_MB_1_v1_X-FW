...
/* USER CODE BEGIN EC */
#define LORAWAN_USER_ERROR_PORT                     66
#define LORAWAN_USER_RESET_REASON_PORT              67
#define LORAWAN_USER_BEACON_PORT                    68
#define LORAWAN_USER_HEART_BEAT_PORT                69
